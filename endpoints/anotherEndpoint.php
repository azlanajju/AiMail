...
class EmailSummarizer {
    ...
    private function summarizeWithGemini($emailContent) {
        ...
        $prompt = "Please group these emails into topics so it is easy for an user to calsify, also give it like key value paris where every clasified like key will be clasified header nd its values are array od emails:\n\n" . $emailContent;
